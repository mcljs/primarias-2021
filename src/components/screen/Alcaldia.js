    ...
    return (
      ...
      <h1 className="flex flex-col items-center">
        ...
        <div className="mt-[1600px] pr-20">
            <iframe className="responsive-iframe md:pl-[250px] pl-4" src="https://docs.google.com/forms/d/e/1FAIpQLScea5GqyO9SxmQjhHe5ule4NiNOlGODBJaDIEP4XYR14PRHBQ/viewform?embedded=true"></iframe>
</div>
